...
int main(int argc, char const *argv[])
{
    ...
    /*std::vector<std::string> total_1p_numerator_sample_name_nm={"NOMINAL_reg2mtau1b2jss_1prong_vetobtagwp70_highmet_leading_index_bin",
    "NOMINAL_reg2mtau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin","NOMINAL_reg2mtau1b3jss_1prong_vetobtagwp70_highmet_leading_index_bin",
    "NOMINAL_reg2mtau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin","NOMINAL_reg2mtau1b2jss_3prong_vetobtagwp70_highmet_leading_index_bin",
     "NOMINAL_reg2mtau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin","NOMINAL_reg2mtau1b3jss_3prong_vetobtagwp70_highmet_leading_index_bin",
      "NOMINAL_reg2mtau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin"};
   */
      std::vector<std::string> total_1p_numerator_sample_name_nm={
     "NOMINAL_reg2mtau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg2mtau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg2mtau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg2mtau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin"};

     /*
     std::vector<std::string> total_1p_denominator_sample_name_nm={"NOMINAL_reg1mtau1ltau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1ltau1mtau1b3jss_1prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1ltau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1ltau1mtau1b3jss_3prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1ltau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1ltau1mtau1b2jss_1prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1ltau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1ltau1mtau1b2jss_3prong_vetobtagwp70_highmet_leading_index_bin"};
     */
    
      std::vector<std::string> total_1p_denominator_sample_name_nm={"NOMINAL_reg1mtau1ltau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
      "NOMINAL_reg1mtau1ltau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
      "NOMINAL_reg1mtau1ltau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
      "NOMINAL_reg1mtau1ltau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin"};
     
      /* std::vector<std::string> total_1p_denominator_sample_name_lnm={"NOMINAL_reg1mtau1lnmtau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1lnmtau1mtau1b3jss_1prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1lnmtau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1lnmtau1mtau1b3jss_3prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1lnmtau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1lnmtau1mtau1b2jss_1prong_vetobtagwp70_highmet_leading_index_bin","NOMINAL_reg1mtau1lnmtau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
     "NOMINAL_reg1lnmtau1mtau1b2jss_3prong_vetobtagwp70_highmet_leading_index_bin"}; */

       std::vector<std::string> total_1p_denominator_sample_name_lnm={
        "NOMINAL_reg1mtau1lnmtau1b3jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
        "NOMINAL_reg1mtau1lnmtau1b3jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
        "NOMINAL_reg1mtau1lnmtau1b2jss_1prong_vetobtagwp70_highmet_subleading_index_bin",
        "NOMINAL_reg1mtau1lnmtau1b2jss_3prong_vetobtagwp70_highmet_subleading_index_bin",
       };
    ...
    for(int i=0;i<bkgsample.size();i++){
      for (int icamp = 0; icamp < 3;icamp++)
      {
        ...
        for(int jorigin=0;jorigin<origin.size();jorigin++){
          ...
          for(int j=0;j<total_1p_numerator_sample_name.size();j++){
            TH1D* htmp;
            //std::cout<<"name:"<<(bkgsample.at(i)).name+"_"+total_1p_numerator_sample_name.at(j)<<std::endl;
          ...
          for(int j=0;j<total_1p_denominator_sample_name.size();j++){
            TH1D* htmp;
            //std::cout<<"name:"<<(bkgsample.at(i)).name+"_"+total_1p_denominator_sample_name.at(j)<<std::endl;
  ...
  TFile *outputfile=new TFile((std::string(PACKAGE_DIR)+"/FF_ss_"+(category_==1?"nm":"lnm")+".root").c_str(),"recreate");
  outputfile->cd();
  outhist1p->Write();
  outputfile->Close();
