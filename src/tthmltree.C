    ...
    if (sample.Contains("data")) {
      ...
      if(belong_regions.have("2l")){
        if(lep_truthType_1 == 2 || lep_truthType_1 == 6) {
          if(lep_truthPdgId_1 == lep_ID_1) leporigin = sample + "_reallep";
        ...
        if(mc_channel_number!=0){
          ...
          for (int iNP = 0; iNP < plotNPs.size(); ++iNP){
            ...
            if (fcnc) {
              ...
              else if(tau_MV2c10_0<defaultbtagwp && region.Contains("2l")) fcnc_plots->fill_hist(leporigin,region,theNP);
            }
