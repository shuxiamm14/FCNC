...
bool tthmltree::addWeightSys(){
  ...
  addweights(lepSFObjLoose_EL_SF_ID_DOWN,"Ele_ID_down");
  addweights(lepSFObjLoose_EL_SF_Isol_UP,"Ele_Isol_up");
  addweights(lepSFObjLoose_EL_SF_Isol_DOWN,"Ele_Isol_down");
  addweights(lepSFObjLoose_MU_SF_ID_STAT_UP,"Mu_ID_STAT_up");
  addweights(lepSFObjLoose_MU_SF_ID_STAT_DOWN,"Mu_ID_STAT_down");
  addweights(lepSFObjLoose_MU_SF_ID_SYST_UP,"Mu_ID_SYST_up");
  addweights(lepSFObjLoose_MU_SF_ID_SYST_DOWN,"Mu_ID_SYST_down");
  addweights(lepSFObjLoose_MU_SF_ID_STAT_LOWPT_UP,"Mu_ID_STAT_LOWPT_up");
  addweights(lepSFObjLoose_MU_SF_ID_STAT_LOWPT_DOWN,"Mu_ID_STAT_LOWPT_down");
  addweights(lepSFObjLoose_MU_SF_ID_SYST_LOWPT_UP,"Mu_ID_SYST_LOWPT_up");
  addweights(lepSFObjLoose_MU_SF_ID_SYST_LOWPT_DOWN,"Mu_ID_SYST_LOWPT_down");
  addweights(lepSFObjLoose_MU_SF_Isol_STAT_UP,"Mu_Isol_STAT_up");
  addweights(lepSFObjLoose_MU_SF_Isol_STAT_DOWN,"Mu_Isol_STAT_down");
  addweights(lepSFObjLoose_MU_SF_Isol_SYST_UP,"Mu_Isol_SYST_up");
  addweights(lepSFObjLoose_MU_SF_Isol_SYST_DOWN,"Mu_Isol_SYST_down");
  addweights(lepSFObjLoose_MU_SF_TTVA_STAT_UP,"Mu_TTVA_STAT_up");
  addweights(lepSFObjLoose_MU_SF_TTVA_STAT_DOWN,"Mu_TTVA_STAT_down");
  addweights(lepSFObjLoose_MU_SF_TTVA_SYST_UP,"Mu_TTVA_SYST_up");
  addweights(lepSFObjLoose_MU_SF_TTVA_SYST_DOWN,"Mu_TTVA_SYST_down");
  addweights(tauSFTight_TAU_SF_ELEOLR_TOTAL_UP,"tauEveto_TOTAL_up");
  addweights(tauSFTight_TAU_SF_ELEOLR_TOTAL_DOWN,"tauEveto_TOTAL_down");
  addweights(tauSFTight_TAU_SF_TRUEELECTRON_ELEOLR_TOTAL_UP,"tauEveto_E_TOTAL_up");
  addweights(tauSFTight_TAU_SF_TRUEELECTRON_ELEOLR_TOTAL_DOWN,"tauEveto_E_TOTAL_down");
  addweights(tauSFTight_TAU_SF_JETID_TOTAL_UP,"tauID_TOTAL_up");
  addweights(tauSFTight_TAU_SF_JETID_TOTAL_DOWN,"tauID_TOTAL_down");
  addweights(tauSFTight_TAU_SF_JETID_HIGHPT_UP,"tauID_HIGHPT_up");
  addweights(tauSFTight_TAU_SF_JETID_HIGHPT_DOWN,"tauID_HIGHPT_down");
  addweights(tauSFTight_TAU_SF_RECO_TOTAL_UP,"tauRecon_TOTAL_up");
  addweights(tauSFTight_TAU_SF_RECO_TOTAL_DOWN,"tauRecon_TOTAL_down");
  addweights(tauSFTight_TAU_SF_RECO_HIGHPT_UP,"tauRecon_HIGHPT_up");
  addweights(tauSFTight_TAU_SF_RECO_HIGHPT_DOWN,"tauRecon_HIGHPT_down");
  addweights(JVT_EventWeight_UP,"jvt_up");
  addweights(JVT_EventWeight_DOWN,"jvt_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B0_up,"btag_B_0_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B0_down,"btag_B_0_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B1_up,"btag_B_1_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B1_down,"btag_B_1_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B2_up,"btag_B_2_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B2_down,"btag_B_2_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B3_up,"btag_B_3_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B3_down,"btag_B_3_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B4_up,"btag_B_4_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B4_down,"btag_B_4_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B5_up,"btag_B_5_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B5_down,"btag_B_5_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B6_up,"btag_B_6_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B6_down,"btag_B_6_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B7_up,"btag_B_7_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B7_down,"btag_B_7_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B8_up,"btag_B_8_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_B8_down,"btag_B_8_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C0_up,"btag_C_0_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C0_down,"btag_C_0_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C1_up,"btag_C_1_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C1_down,"btag_C_1_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C2_up,"btag_C_2_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C2_down,"btag_C_2_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C3_up,"btag_C_3_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_C3_down,"btag_C_3_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light0_up,"btag_Light_0_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light0_down,"btag_Light_0_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light1_up,"btag_Light_1_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light1_down,"btag_Light_1_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light2_up,"btag_Light_2_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light2_down,"btag_Light_2_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light3_up,"btag_Light_3_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light3_down,"btag_Light_3_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light4_up,"btag_Light_4_up");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_Light4_down,"btag_Light_4_down");
  addweights(bTagSF_weight_MV2c10_FixedCutBEff_70_extrapolation_up,"btag_extrapolation_up");
