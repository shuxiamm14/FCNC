...
void nominal::initMVA(TString fcnc_region){
  ...
  if(fcnc_region == "reg2mtau1b3jos" || fcnc_region == "reg2mtau1b2jos" || fcnc_region == "reg1l1tau1b3j"){
  ...
  reader[fcnc_region]->BookMVA( "BDTG_1" , TString(PACKAGE_DIR) + "/run/hadhadhists/reduce2/dataset/weights/" + fcnc_region + "TMVAClassification_1_BDTG.weights.xml" );
  reader[fcnc_region]->BookMVA( "BDTG_2" , TString(PACKAGE_DIR) + "/run/hadhadhists/reduce2/dataset/weights/" + fcnc_region + "TMVAClassification_2_BDTG.weights.xml" );
}
