#include "tthmltree.h"
class tthmltree_v2 : public tthmltree{
public:
   ...
   std::vector<int>     *m_jet_tagWeightBin;
   ...
   std::vector<float>   *m_mcevt_pdf_X1;
   std::vector<float>   *m_mcevt_pdf_X2;
   std::vector<int>     *m_mcevt_pdf_PDGID1;
   std::vector<int>     *m_mcevt_pdf_PDGID2;
   ...
   std::vector<int>     *vtx_type;
   std::vector<int>     *vtx_numTrk;
   std::vector<char>    *electron_isolationLooseTrackOnly;
   std::vector<char>    *muon_isolationLooseTrackOnly;
   std::vector<char>    *electron_isolationLoose;
   std::vector<char>    *muon_isolationLoose;
   std::vector<char>    *electron_isolationGradient;
   std::vector<char>    *muon_isolationGradient;
   std::vector<char>    *electron_isolationGradientLoose;
   std::vector<char>    *muon_isolationGradientLoose;
   std::vector<char>    *electron_isolationFixedCutTightTrackOnly;
   std::vector<char>    *muon_isolationFixedCutTightTrackOnly;
   std::vector<char>    *electron_isolationFixedCutLoose;
   std::vector<char>    *muon_isolationFixedCutLoose;
   std::vector<char>    *electron_isolationFixedCutTight;
   std::vector<float>   *electron_pt;
   std::vector<float>   *electron_eta;
   std::vector<float>   *electron_EtaBE2;
   std::vector<float>   *electron_phi;
   std::vector<float>   *electron_E;
   std::vector<int>     *electron_ID;
   std::vector<float>   *electron_sigd0PV;
   std::vector<float>   *electron_z0SinTheta;
   std::vector<float>   *electron_topoetcone20;
   std::vector<float>   *electron_topoetcone30;
   std::vector<float>   *electron_topoetcone40;
   std::vector<float>   *electron_ptvarcone20;
   std::vector<float>   *electron_ptvarcone30;
   std::vector<float>   *electron_ptvarcone40;
   std::vector<char>    *electron_isLooseLH;
   std::vector<char>    *electron_isMediumLH;
   std::vector<char>    *electron_isTightLH;
   std::vector<char>    *electron_sharesTrk;
   std::vector<char>    *electron_passOR;
   std::vector<char>    *electron_isQMisID;
   std::vector<float>   *electron_ChargeIDBDTLoose;
   std::vector<float>   *electron_ChargeIDBDTMedium;
   std::vector<float>   *electron_ChargeIDBDTTight;
   std::vector<int>     *electron_match_HLT_2e12_lhloose_L12EM10VH;
   std::vector<int>     *electron_match_HLT_2e12_lhvloose_nod0_L12EM10VH;
   std::vector<int>     *electron_match_HLT_2e12_loose_L12EM10VH;
   std::vector<int>     *electron_match_HLT_2e15_lhvloose_nod0_L12EM13VH;
   std::vector<int>     *electron_match_HLT_2e17_lhvloose_nod0;
   std::vector<int>     *electron_match_HLT_2e17_lhvloose_nod0_L12EM15VHI;
   std::vector<int>     *electron_match_HLT_2e24_lhvloose_nod0;
   std::vector<int>     *electron_match_HLT_e120_lhloose;
   std::vector<int>     *electron_match_HLT_e12_lhloose;
   std::vector<int>     *electron_match_HLT_e12_loose;
   std::vector<int>     *electron_match_HLT_e140_lhloose;
   std::vector<int>     *electron_match_HLT_e140_lhloose_nod0;
   std::vector<int>     *electron_match_HLT_e140_loose;
   std::vector<int>     *electron_match_HLT_e17_lhloose;
   std::vector<int>     *electron_match_HLT_e17_lhloose_2e9_lhloose;
   std::vector<int>     *electron_match_HLT_e17_lhloose_mu14;
   std::vector<int>     *electron_match_HLT_e17_lhloose_nod0_mu14;
   std::vector<int>     *electron_match_HLT_e17_lhmedium_nod0_ivarloose_tau25_medium1_tracktwo;
   std::vector<int>     *electron_match_HLT_e17_lhmedium_nod0_tau25_medium1_tracktwo;
   std::vector<int>     *electron_match_HLT_e17_lhmedium_tau25_medium1_tracktwo;
   std::vector<int>     *electron_match_HLT_e17_loose;
   std::vector<int>     *electron_match_HLT_e17_loose_mu14;
   std::vector<int>     *electron_match_HLT_e24_lhmedium_L1EM18VH;
   std::vector<int>     *electron_match_HLT_e24_lhmedium_L1EM20VH;
   std::vector<int>     *electron_match_HLT_e24_lhmedium_iloose_L1EM18VH;
   std::vector<int>     *electron_match_HLT_e24_lhmedium_nod0_L1EM20VH;
   std::vector<int>     *electron_match_HLT_e24_lhmedium_nod0_L1EM20VHI_mu8noL1;
   std::vector<int>     *electron_match_HLT_e24_lhtight_iloose;
   std::vector<int>     *electron_match_HLT_e24_lhtight_iloose_L1EM20VH;
   std::vector<int>     *electron_match_HLT_e24_lhtight_ivarloose;
   std::vector<int>     *electron_match_HLT_e24_lhtight_nod0_ivarloose;
   std::vector<int>     *electron_match_HLT_e24_medium_L1EM20VHI_mu8noL1;
   std::vector<int>     *electron_match_HLT_e24_tight_iloose;
   std::vector<int>     *electron_match_HLT_e24_tight_iloose_L1EM20VH;
   std::vector<int>     *electron_match_HLT_e26_lhmedium_nod0_L1EM22VHI_mu8noL1;
   std::vector<int>     *electron_match_HLT_e26_lhtight_iloose;
   std::vector<int>     *electron_match_HLT_e26_lhtight_nod0_ivarloose;
   std::vector<int>     *electron_match_HLT_e26_tight_iloose;
   std::vector<int>     *electron_match_HLT_e300_etcut;
   std::vector<int>     *electron_match_HLT_e5_lhloose;
   std::vector<int>     *electron_match_HLT_e5_loose;
   std::vector<int>     *electron_match_HLT_e60_lhmedium;
   std::vector<int>     *electron_match_HLT_e60_lhmedium_nod0;
   std::vector<int>     *electron_match_HLT_e60_medium;
   std::vector<int>     *electron_match_HLT_e7_lhmedium_mu24;
   std::vector<int>     *electron_match_HLT_e7_lhmedium_nod0_mu24;
   std::vector<int>     *electron_match_HLT_e7_medium_mu24;
   std::vector<int>     *electron_nInnerPix;
   std::vector<int>     *electron_author;
   std::vector<float>   *electron_d0;
   std::vector<float>   *electron_z0;
   std::vector<float>   *electron_vz;
   std::vector<float>   *electron_deltaz0;
   std::vector<int>     *electron_truthOrigin;
   std::vector<int>     *electron_truthType;
   std::vector<int>     *electron_firstEgMotherPdgId;
   std::vector<float>   *electron_jetFitterComb;
   std::vector<short>   *electron_PromptLeptonInput_sv1_jf_ntrkv;
   std::vector<short>   *electron_PromptLeptonInput_TrackJetNTrack;
   std::vector<float>   *electron_PromptLeptonInput_DL1mu;
   std::vector<float>   *electron_PromptLeptonInput_DRlj;
   std::vector<float>   *electron_PromptLeptonInput_LepJetPtFrac;
   std::vector<float>   *electron_PromptLeptonInput_PtFrac;
   std::vector<float>   *electron_PromptLeptonInput_PtRel;
   std::vector<float>   *electron_PromptLeptonInput_ip2;
   std::vector<float>   *electron_PromptLeptonInput_ip3;
   std::vector<float>   *electron_PromptLeptonInput_rnnip;
   std::vector<float>   *electron_PromptLeptonIso_TagWeight;
   std::vector<float>   *electron_PromptLeptonVeto_TagWeight;
   std::vector<unsigned char> *electron_ambiguityType;
   std::vector<unsigned char> *electron_numberOfInnermostPixelLayerHits;
   std::vector<unsigned char> *electron_numberOfInnermostPixelLayerOutliers;
   std::vector<unsigned char> *electron_expectInnerPixelLayerHit;
   std::vector<float>   *muon_pt;
   std::vector<float>   *muon_eta;
   std::vector<float>   *muon_phi;
   std::vector<float>   *muon_E;
   std::vector<char>    *muon_isLoose;
   std::vector<char>    *muon_isMedium;
   std::vector<char>    *muon_isTight;
   std::vector<int>     *muon_ID;
   std::vector<float>   *muon_sigd0PV;
   std::vector<float>   *muon_z0SinTheta;
   std::vector<float>   *muon_momBalSignif;
   std::vector<float>   *muon_scatCurvSignif;
   std::vector<float>   *muon_scatNeighSignif;
   std::vector<float>   *muon_rho;
   std::vector<float>   *muon_qOverPsigma;
   std::vector<float>   *muon_qOverPsignif;
   std::vector<float>   *muon_reducedChi2;
   std::vector<unsigned char> *muon_numPrecLayers;
   std::vector<float>   *muon_topoetcone20;
   std::vector<float>   *muon_topoetcone30;
   std::vector<float>   *muon_topoetcone40;
   std::vector<float>   *muon_ptvarcone20;
   std::vector<float>   *muon_ptvarcone30;
   std::vector<float>   *muon_ptvarcone40;
   std::vector<char>    *muon_sharesTrk;
   std::vector<char>    *muon_passOR;
   std::vector<char>    *muon_isQMisID;
   std::vector<int>     *muon_match_HLT_2mu10;
   std::vector<int>     *muon_match_HLT_2mu14;
   std::vector<int>     *muon_match_HLT_e17_lhloose_mu14;
   std::vector<int>     *muon_match_HLT_e17_lhloose_nod0_mu14;
   std::vector<int>     *muon_match_HLT_e17_loose_mu14;
   std::vector<int>     *muon_match_HLT_e24_lhmedium_nod0_L1EM20VHI_mu8noL1;
   std::vector<int>     *muon_match_HLT_e24_medium_L1EM20VHI_mu8noL1;
   std::vector<int>     *muon_match_HLT_e26_lhmedium_nod0_L1EM22VHI_mu8noL1;
   std::vector<int>     *muon_match_HLT_e7_lhmedium_mu24;
   std::vector<int>     *muon_match_HLT_e7_lhmedium_nod0_mu24;
   std::vector<int>     *muon_match_HLT_e7_medium_mu24;
   std::vector<int>     *muon_match_HLT_mu10;
   std::vector<int>     *muon_match_HLT_mu14;
   std::vector<int>     *muon_match_HLT_mu14_ivarloose_tau25_medium1_tracktwo;
   std::vector<int>     *muon_match_HLT_mu14_tau25_medium1_tracktwo;
   std::vector<int>     *muon_match_HLT_mu18;
   std::vector<int>     *muon_match_HLT_mu18_mu8noL1;
   std::vector<int>     *muon_match_HLT_mu20_iloose_L1MU15;
   std::vector<int>     *muon_match_HLT_mu20_mu8noL1;
   std::vector<int>     *muon_match_HLT_mu22_mu8noL1;
   std::vector<int>     *muon_match_HLT_mu24;
   std::vector<int>     *muon_match_HLT_mu24_iloose;
   std::vector<int>     *muon_match_HLT_mu24_imedium;
   std::vector<int>     *muon_match_HLT_mu24_ivarloose;
   std::vector<int>     *muon_match_HLT_mu24_ivarmedium;
   std::vector<int>     *muon_match_HLT_mu26_imedium;
   std::vector<int>     *muon_match_HLT_mu26_ivarmedium;
   std::vector<int>     *muon_match_HLT_mu40;
   std::vector<int>     *muon_match_HLT_mu50;
   std::vector<float>   *muon_d0;
   std::vector<float>   *muon_z0;
   std::vector<float>   *muon_vz;
   std::vector<float>   *muon_deltaz0;
   std::vector<int>     *muon_author;
   std::vector<int>     *muon_type;
   std::vector<int>     *muon_truthType;
   std::vector<int>     *muon_truthOrigin;
   std::vector<int>     *muon_trackType;
   std::vector<int>     *muon_trackOrigin;
   std::vector<float>   *muon_jetFitterComb;
   std::vector<short>   *muon_PromptLeptonInput_sv1_jf_ntrkv;
   std::vector<short>   *muon_PromptLeptonInput_TrackJetNTrack;
   std::vector<float>   *muon_PromptLeptonInput_DL1mu;
   std::vector<float>   *muon_PromptLeptonInput_DRlj;
   std::vector<float>   *muon_PromptLeptonInput_LepJetPtFrac;
   std::vector<float>   *muon_PromptLeptonInput_PtFrac;
   std::vector<float>   *muon_PromptLeptonInput_PtRel;
   std::vector<float>   *muon_PromptLeptonInput_ip2;
   std::vector<float>   *muon_PromptLeptonInput_ip3;
   std::vector<float>   *muon_PromptLeptonInput_rnnip;
   std::vector<float>   *muon_PromptLeptonIso_TagWeight;
   std::vector<float>   *muon_PromptLeptonVeto_TagWeight;
   std::vector<float>   *muon_jet_pt;
   std::vector<float>   *muon_jet_eta;
   std::vector<float>   *muon_jet_phi;
   std::vector<float>   *muon_jet_dr;
   std::vector<float>   *muon_jet_ptRel;
   std::vector<float>   *muon_jet_numTrk;
   std::vector<float>   *muon_jet_sumPtTrk;
   std::vector<float>   *muon_jet_MV2c10_Weight;
   std::vector<float>   *muon_jet_tagWeightBin;
   std::vector<float>   *muon_jet_BDT;
   std::vector<float>   *m_jet_pt;
   std::vector<float>   *m_jet_eta;
   std::vector<float>   *m_jet_phi;
   std::vector<float>   *m_jet_E;
   std::vector<double>  *m_jet_etaEM;
   std::vector<float>   *m_jet_jvt;
   std::vector<int>     *m_jet_passjvt;
   std::vector<int>     *m_jet_isLooseBad;
   std::vector<float>   *m_jet_flavor_weight_MV2c10;
   std::vector<int>     *m_jet_numTrk;
   std::vector<char>    *m_jet_passOR;
   std::vector<char>    *m_jet_passTauOR;
   std::vector<float>   *m_jet_flavor_weight_MV2c00;
   std::vector<float>   *m_jet_flavor_weight_MV2c20;
   std::vector<float>   *m_jet_sumPtTrk;
   ...
   std::vector<float>   *m_tau_numTrack;
   std::vector<double>  *m_tau_BDTJetScore;
   std::vector<int>     *m_tau_JetBDTSigLoose;
   std::vector<int>     *m_tau_JetBDTSigMedium;
   std::vector<int>     *m_tau_JetBDTSigTight;
   std::vector<int>     *m_tau_MVATESQuality;
   std::vector<char>    *m_tau_passOR;
   std::vector<int>     *m_tau_passEleOLR;
   std::vector<int>     *m_tau_passEleBDT;
   std::vector<int>     *m_tau_passMuonOLR;
   std::vector<int>     *m_tau_isHadronicTau;
   std::vector<float>   *m_tau_MV2c10;
   std::vector<int>     *m_tau_tagWeightBin;
   std::vector<char>    *m_tau_passJVT;
   std::vector<char>    *m_tau_fromPV;
   std::vector<float>   *m_tau_BDTEleScoreSigTrans;
   std::vector<double>  *m_tau_BDTJetScoreSigTrans;
   std::vector<float>   *m_tau_ptTauEtaCalib;
   std::vector<float>   *m_tau_etaTauEtaCalib;
   std::vector<float>   *m_tau_phiTauEtaCalib;
   std::vector<float>   *m_tau_mTauEtaCalib;
   std::vector<int>     *m_tau_isTruthMatched;
   std::vector<int>     *m_tau_truthOrigin;
   std::vector<int>     *m_tau_truthType;
   std::vector<int>     *m_tau_truthJetFlavour;
   std::vector<float>   *m_tau_ele_match_lhscore;
   std::vector<short>   *m_tau_PromptTauInput_TrackJetNTrack;
   std::vector<float>   *m_tau_PromptTauInput_DRlj;
   std::vector<float>   *m_tau_PromptTauInput_JetF;
   std::vector<float>   *m_tau_PromptTauInput_LepJetPtFrac;
   std::vector<float>   *m_tau_PromptTauInput_MV2c10rnn;
   std::vector<float>   *m_tau_PromptTauInput_SV1;
   std::vector<float>   *m_tau_PromptTauInput_ip2;
   std::vector<float>   *m_tau_PromptTauInput_ip3;
   std::vector<float>   *m_tau_PromptTauInput_rnnip;
   std::vector<float>   *m_tau_PromptTauInput_MV2c10;
   std::vector<float>   *m_tau_PromptTauVeto;
   std::vector<float>   *m_tau_PromptTauIso;
   Float_t         lep_ID_0;
   Int_t           lep_Index_0;
   Float_t         lep_Pt_0;
   Float_t         lep_E_0;
   ...
   std::vector<short>   *selected_jets_mv2c10_Ordrd;
   std::vector<short>   *selected_jets_T_mv2c10_Ordrd;
